...
const G = {
  ...
  date: a,
  message: n
}) => n ? /* @__PURE__ */ e.createElement("div", { className: "displayer_container" }, n) : /* @__PURE__ */ e.createElement("div", { className: "displayer_container" }, `${t[a.getMonth()]} ${a.getFullYear()}`), ae = (t) => Math.floor(t.getTime() / 1e3), ne = (t, a) => 32 - new Date(t, a, 32).getDate(), O = (t) => {
